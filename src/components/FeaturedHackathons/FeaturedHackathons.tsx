        ...
        <section className="bg-white py-16 sm:py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mt-8">
                    <a href="#" className="inline-flex items-center justify-center bg-white text-[#191919] border border-black/10 px-5 py-2.5 rounded-lg text-base font-medium no-underline cursor-pointer transition-colors duration-200 hover:bg-black/5">
                        View More
                    </a>
                </div>
            </div>
